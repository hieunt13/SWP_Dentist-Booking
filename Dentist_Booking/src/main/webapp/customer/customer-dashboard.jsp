        ...
        <![endif]-->
                                                                                                                ...
                                                                                                                <tbody>
                                                                                                                    <c:forEach var="list" items="${APPOINTMENT_LIST}">
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            ${list.status == 1 ? "
                                                                                                                            <td><span class=\ "badge badge-pill bg-warning-light\">Pending</span></td>":""} ${list.status == 0 ? "
                                                                                                                            <td><span class=\ "badge badge-pill bg-danger-light\">Canceled</span></td>":""} ${list.status == 2 ? "
                                                                                                                            <td><span class=\ "badge badge-pill bg-success-light\">Accepted</span></td>":""}
                                                                                                                            <td class="text-right">
                                                                                                                                <div class="table-action">
                                                                                                                                    <<<<<<< HEAD <c:if test="${list.paymentConfirm == 0 && list.dentistConfirm == 1 && list.status == 2}">
                                    ...
                                    <span aria-hidden="true">&times;</span>
                                            ...
                                            <c:forEach var="appointment" items="${EMPLOYEE_APPOINTMENT_DETAIL_LIST}">
                                                ...
                                                <li>
                                                    <a href="#" class="btn btn-sm bg-success-light btn-block">
