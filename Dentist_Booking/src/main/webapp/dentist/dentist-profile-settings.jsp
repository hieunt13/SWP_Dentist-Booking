...
<html lang="en">
    ...
    <head>
        ...
        <!-- Bootstrap CSS -->
        <link rel="stylesheet" href="<%=request.getContextPath()%>/dentist/assets/plugins/bootstrap-tagsinput/css/bootstrap-tagsinput.css">

        <link rel="stylesheet" href="<%=request.getContextPath()%>/dentist/assets/plugins/dropzone/dropzone.min.css">
