...
<![endif]-->
            ...
            <body>
                        ...
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-12 col-12">
                                    ...
                                    <h2 class="breadcrumb-title">Appointments checkin
                                        <h2>
                                </div>
                            </div>
                        </div>
                                                                                ...
                                                                                <c:if test="${list.status == 1}">
                                                                                    <td class="text-right">
                                                                                        <div class="table-action">
                                                                                            ...
                                                                                            <a href="#" class="btn btn-sm bg-info-light btn-block" data-toggle="modal" data-target="#${list.id}">
                ...
                <li>
                    <a href="<%=request.getContextPath()%>/UpdateAppointmentStatusController?appointmentID=${list.id}" class="btn btn-sm bg-success-light btn-block">
                ...
                <li>
                    <a href="<%=request.getContextPath()%>/EmployeeInvoiceDetail?appointmentId=${list.id}" class="btn btn-sm bg-success-light btn-block">
