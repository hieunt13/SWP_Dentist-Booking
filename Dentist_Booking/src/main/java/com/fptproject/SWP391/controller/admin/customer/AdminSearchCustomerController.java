 ...
 * @author admin
 */
@WebServlet(name = "AdminSearchCustomerController", urlPatterns = {"/admin/AdminSearchCustomerController"})
public class AdminSearchCustomerController extends HttpServlet {
    private static final String ERROR= "/admin/patient-management.jsp";
    private static final String SUCCESS= "/admin/patient-management.jsp";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(customerList.size()>0){
                ...
                log("Error at AdminSearchCustomer Controller: " + e.toString());
        }finally{
