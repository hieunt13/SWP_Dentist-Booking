 ...
 * @author admin
 */
@WebServlet(name = "AdminRestoreFeedbackController", urlPatterns = {"/admin/AdminRestoreFeedbackController"})
public class AdminRestoreFeedbackController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            AdminFeedbackManager feedbackDAO = new AdminFeedbackManager();
                boolean check = feedbackDAO.restoreFeedback(feedbackID);
                if (check){
                    url = SUCCESS;
                    request.setAttribute("SUCCESS", "Restore successfully");
                }
        }catch(Exception e){
            log("Error at AdminRestoreFeedback Controller: "+e.toString());
        }finally{
