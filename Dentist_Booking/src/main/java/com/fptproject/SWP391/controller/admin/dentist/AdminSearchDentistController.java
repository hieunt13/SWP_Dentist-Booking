 ...
 * @author admin
 */
@WebServlet(name = "AdminSearchDentistController", urlPatterns = {"/admin/AdminSearchDentistController"})
public class AdminSearchDentistController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(dentistList.size()>0){
                ...
                log("Error at AdminSearchDentist Controller: " + e.toString());
        }finally{
