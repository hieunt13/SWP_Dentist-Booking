...
//
//import com.fptproject.SWP391.manager.employee.EmployeeAppointmentDetailManager;
...
//public class AppointmentController2 extends HttpServlet {
//
...
//                EmployeeAppointmentDetailManager appointmentDetailDAO = new EmployeeAppointmentDetailManager();
//                List<Appointment> appointmentPendingList = appointmentDAO.getListPendingAppointment();
//                List<AppointmentDetail> appointmentDetailPendingList = appointmentDetailDAO.getListPendingAppointmentDetail();
//                if (appointmentPendingList.size() == 0 || appointmentDetailPendingList.size() == 0) {
//                    msg = "nothing In Your List!";
//                } else {
//                    request.setAttribute("EMPLOYEE_APPOINTMENT_LIST", appointmentPendingList);
//                    request.setAttribute("EMPLOYEE_APPOINTMENT_DETAIL_LIST", appointmentDetailPendingList);
//                    msg = "Success!";
//                }
