 ...
 * @author admin
 */
@WebServlet(name = "AdminRestoreCustomerController", urlPatterns = {"/admin/AdminRestoreCustomerController"})
public class AdminRestoreCustomerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            String ID = request.getParameter("customerID");
                ...
                boolean check = customerDAO.restoreCustomer(ID);
                if (check){
                    url = SUCCESS;
