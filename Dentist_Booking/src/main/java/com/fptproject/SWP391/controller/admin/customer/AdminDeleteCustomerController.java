 ...
 * @author admin
 */
@WebServlet(name = "AdminDeleteCustomerController", urlPatterns = {"/admin/AdminDeleteCustomerController"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(appointmnetDAO.checkDeleteCondition(ID) == false){
                request.setAttribute("ERROR", "Fail to delete (This customer still appears in one or more appointments)");
            }else{
